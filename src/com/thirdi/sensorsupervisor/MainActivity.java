...
public class MainActivity extends Activity
    ...
    public void onSectionAttached(int number) {
        ...
        switch (number) {
            case 1:
                ...
                mFragmentTransaction.replace(R.id.container, mSensorFragment);
                mFragmentTransaction.commit();
                break;
            case 2:
                mTitle = getString(R.string.title_section2);
                mFragmentTransaction = mFragmentManager.beginTransaction();
                mFragmentTransaction.replace(R.id.container, mGPSFragment);
                mFragmentTransaction.commit();
                break;
            case 3:
                mTitle = getString(R.string.title_section3);
                mFragmentTransaction = mFragmentManager.beginTransaction();
                mFragmentTransaction.replace(R.id.container, mNetworkFragment);
                mFragmentTransaction.commit();
                break;
            case 4:
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
        	//Settings is selected, bring settings in front.
        	mTitle = getString(R.string.action_settings);
        	mFragmentTransaction = mFragmentManager.beginTransaction();
        	mFragmentTransaction.replace(R.id.container, mSettingsFragment);
        	mFragmentTransaction.commit();
